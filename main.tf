    ...
    "Statement" : [
      {
        ...
        "Resource" : [
          ...
          "arn:aws:ssm:us-east-1:389812956364:parameter/nexus*",
          "arn:aws:ssm:us-east-1:389812956364:parameter/${var.env}.docdb*",
          "arn:aws:ssm:us-east-1:389812956364:parameter/${var.env}.elasticache*",
          "arn:aws:ssm:us-east-1:389812956364:parameter/${var.env}.rds*",
          "arn:aws:ssm:us-east-1:389812956364:parameter/${var.env}.rabbitmq*"
        ]
      },
      {
        "Sid" : "VisualEditor1",
...
resource "aws_lb_listener_rule" "backend_rule" {
  ...
  condition {
    host_header {
      values = ["${var.component}-${var.env}.arjundevops.online"]
    }
  }
}
